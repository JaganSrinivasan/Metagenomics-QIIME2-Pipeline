...
A step-by-step bioinformatics pipeline using **QIIME2 (v1.4.2)** to analyze and characterize the diversity of microbial communities from marker gene sequencing data (e.g., 16S rRNA).
